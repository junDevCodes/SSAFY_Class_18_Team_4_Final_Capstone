<template>
  <div class="group relative flex flex-col cursor-pointer">
    <div class="relative aspect-[3/4] bg-gray-50 rounded-lg overflow-hidden mb-5">
      ...
      <div v-if="product.isBest" class="absolute top-0 left-0 bg-gray-900 text-white text-[10px] font-bold px-3 py-1.5 uppercase tracking-wider">Best</div>
    </div>

    <div>
      <div class="text-xs text-gray-500 mb-1 font-medium">{{ product.desc }}</div>
